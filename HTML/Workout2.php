...
<body>
    ...
    <a href="#"><img src="../Image/logo1.png" class="logo" alt=""></a>
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a class="active" href="Workout.php">Workout</a></li>
    ...
    <section id="gym" >
        <h1>WORKOUT</h1>
        <a href="Workout.php"><button class="work">Male</button></a>
        <style>
            .work{
        ...
        <form action="" method="post">
                <a href="Fullbody F.php" style="text-decoration: none;">
                    <img src="../Image/Fullbody_F.jpg" alt="">
                    <div class="des">
                        <span>Easy</span>
        ...
        <div class="pro">
        <form action="" method="post">
                <a href="Arms F.php" style="text-decoration: none;">
                    <img src="../Image/Arms_F.jpg" alt="">
                    <div class="des">
                        <span>Easy</span>
        ...
        <div class="pro">
        <form action="" method="post">
                <a href="Chest F.php" style="text-decoration: none;">
                    <img src="../Image/Chest_F.jpg" alt="">
                    <div class="des">
                        <span>Easy</span>
        ...
        <div class="pro">
        <form action="" method="post">
                <a href="Abs F.php" style="text-decoration: none;">
                    <img src="../Image/Abs_F.jpg" alt="">
                    <div class="des">
                        <span>Easy</span>
        ...
        <div class="pro">
        <form action="" method="post">
                <a href="Back F.php" style="text-decoration: none;">
                    <img src="../Image/Back_F.jpg" alt="">
                    <div class="des">
                        <span>Easy</span>
        ...
        <div class="pro">
        <form action="" method="post">
                <a href="Legs F.php" style="text-decoration: none;">
                    <img src="../Image/Legs_F.jpg" alt="">
                    <div class="des">
                        <span>Easy</span>
